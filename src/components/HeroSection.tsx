  ...
  return (
    <section className="min-h-screen relative flex flex-col items-center justify-start overflow-hidden">
      <ImageCarousel images={coffeeImages}>
        <div className="absolute top-[calc(50%+120px)] left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-7xl w-full mx-auto text-center bg-black/40 backdrop-blur-sm px-12 py-6 rounded-xl z-10">
          <img 
